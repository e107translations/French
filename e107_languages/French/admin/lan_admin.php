...
define("ADLAN_187", "Impossible de créer [x]. Veuillez vérifier les autorisations de votre dossier.");
define("ADLAN_188", "Votre paramètre de fuseau horaire [x] n'est pas valide. Il a été réinitialisé à UTC. Pour le modifier, accédez à Admin -> Préférences -> Options d'affichage de la date.");
define("ADLAN_189", "Les plugins suivants ne sont pas compatibles avec cette version de e107 et doivent être désinstallés:");
define("ADLAN_190", "Besoin d'aide ?");
define("ADLAN_191", "Connectez-vous à notre communauté pour [support gratuit] pour n'importe quels problèmes de mise à niveau que vous pourriez rencontrer.");
define("ADLAN_192", "Connectez-vous à notre communauté pour [support gratuit] pour n'importe quels problèmes e107 que vous pourriez rencontrer.");
define("ADLAN_193", "Le dossier [x] n'est pas accessible en écriture. Veuillez corriger avant de continuer.");
...
define("ADLAN_195", "Ancien dossier déplacé dans le répertoire de sauvegarde");
...
define("LAN_PASSWORD_WARNING", "Il est fortement recommandé que vous [changiez l'encodage mot de passe] à la valeur par défaut de PHP. (Les hachages de mot de passe seront automatiquement mis à niveau lors de la connexion de l’utilisateur.)");
...
define("LAN_DOWNLOADING", "Téléchargement");
define("LAN_ID", "ID");
...
define("LAN_UI_FILE_DELETED", "[X] fichier(s) correctement supprimé(s) !");
...
define("LAN_UNINSTALL", "Désinstaller");
...
define("LAN_UPGRADING", "Mise à niveau ?");
...
define("LAN_UI_X_CANT_EQUAL_Y", "[X] ne peut pas être identique à [y]");
define("LAN_UI_VIEW_GRID_LABEL", "Vue en grille");
define("LAN_UI_VIEW_LIST_LABEL", "Vue en liste");
define("LAN_CHECKING_FOR_UPDATES", "Vérification des mises à jour");
define("LAN_UI_FILTER_NEXT_HOUR", "Prochaine heures");
...
define("LAN_UI_FILTER_NEXT_YEAR", "Année prochaine");
